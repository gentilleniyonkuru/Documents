...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    "✓ TRAVAILLEUR créé: travailleur_user / travailleur123"
                )
            )
        else:
            self.stdout.write(
                self.style.WARNING("⚠ TRAVAILLEUR existe déjà: travailleur_user")
            )
        ...
        if created:
            ...
            self.stdout.write(
                self.style.SUCCESS("✓ MANAGER créé: manager_user / manager123")
            )
        else:
        ...
        if created:
            ...
            self.stdout.write(
                self.style.SUCCESS("✓ CLIENT 1 créé: client_user1 / client123")
            )
        else:
            self.stdout.write(
                self.style.WARNING("⚠ CLIENT 1 existe déjà: client_user1")
            )
        ...
        if created:
            ...
            self.stdout.write(
                self.style.SUCCESS("✓ CLIENT 2 créé: client_user2 / client456")
            )
        else:
            self.stdout.write(
                self.style.WARNING("⚠ CLIENT 2 existe déjà: client_user2")
            )
