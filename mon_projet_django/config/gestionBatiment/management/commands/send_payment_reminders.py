...
from gestionBatiment.models import Paiement, Contrat
from gestionBatiment.email_notifications import send_payment_reminder_email, send_contract_payment_reminder_email
