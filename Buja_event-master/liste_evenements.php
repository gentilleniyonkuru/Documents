...
if (isset($_GET['delete'])) {
    ...
    echo "<p style='color:red; font-weight:bold;'>❌ Événement supprimé avec succès.</p>";
}
...
<a href="form_evenement.php" class="add-btn">➕ Ajouter un événement</a>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
                ...
                <td>
                    <a class='btn edit' href='modifier_evenement.php?id=".$row['id']."'>✏ Modifier</a>
                    <a class='btn delete' href='liste_evenements.php?delete=".$row['id']."' onclick=\"return confirm('Supprimer cet événement ?');\">🗑 Supprimer</a>
                </td>
              </tr>";
    }
    echo "</table>";
